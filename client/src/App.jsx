    ...
    <div className='bg-color'>
      <div className="w-100 bg-color py-2 text-white flex justify-between">
        ...
        <div className='w-80 border flex justify-around'>
          <input className='w-full bg-transparent mx-1 outline-white p-1 placeholder-white text-white focus:border-none focus:outline-none active:border-none' type="text" placeholder="Enter VideoId from Youtube" onChange={(e)=>{setVideoId(e.target.value)}}/>
          <span className='search h-full flex' onClick={getSentiments}><CiSearch className='text-white text-3xl font-bold mx-1 my-auto'/></span>
        </div>
